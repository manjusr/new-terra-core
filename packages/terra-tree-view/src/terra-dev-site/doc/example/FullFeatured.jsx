      ...
      <div>
        ...
        >
          <div style={{ width: '400px', height: '400px' }}>
            ...
            >
              <TreeView.Item id="i1" text="Item 1" actions={this.getWarningAction('i1')} indicators={dueSoonLeafIndicator} />
              ...
              <TreeView.Folder id="f1" text="Folder 1" isInitiallySelected indicators={folderIndicator} >
                ...
                <TreeView.Folder id="f1b" text="Folder 1b" indicators={folderIndicator} >
                  ...
                  <TreeView.Folder id="f1ba" text="Folder 1ba with extra text to cause truncation" actions={this.getAlertAction('f1ba')} indicators={overdueFolderIndicator}  >
              ...
              <TreeView.Folder id="f2" text="Folder 2" actions={this.getAlertAction('f2')} indicators={overdueFolderIndicator} >
              ...
              <TreeView.Folder id="f3" text="Folder 3" indicators={folderIndicator} >
                <TreeView.Item id="f3_i1" text="Folder 3 / Item 1" isInitiallySelected actions={this.getWarningAction('f3_i1')} indicators={dueSoonLeafIndicator}  />
